          ...
          <div className="rounded-lg dark:border-gray-700">
            ...
            <div className='grid grid-cols-[3fr_2fr] gap-4 mb-4'>
              ...
              <div>
                ...
                <div className="flex items-center justify-center rounded h-[265px] bg-gray-50 dark:bg-gray-800 col-span-1">
                ...
                <div className='flex gap-6 mt-2'>
                  <a className='text-[#8A92A6]'>Privacy Policy</a>
                  <a className='text-[#8A92A6]'>Terms of Use</a>
                </div>
              </div>
